...
import { Plus, Network, Cpu, CheckCircle2, Radio, Edit, Trash2, Zap, RadioTower, RotateCw, Search, Activity, AlertTriangle, WifiOff } from 'lucide-react';
  ...
  return (
    <div className="rounded-xl border bg-card p-4 space-y-3">
      ...
      <div className="grid grid-cols-2 gap-2 pt-1">
        <Button variant="outline" size="sm" className="w-full h-9" onClick={onDiagnostics}>
          <Zap className="h-3.5 w-3.5 mr-1.5 text-amber-500" />
          Diagnostics
        </Button>
        <Button variant="outline" size="sm" className="w-full h-9" onClick={onReboot}>
          <RotateCw className="h-3.5 w-3.5 mr-1.5 text-orange-500" />
          Reset Line
        </Button>
        <Button variant="outline" size="sm" className="w-full h-9" onClick={onEdit}>
          <Edit className="h-3.5 w-3.5 mr-1.5" />
          Edit
        </Button>
        <Button variant="outline" size="sm" className="w-full h-9 text-destructive hover:text-destructive" onClick={onDelete}>
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-4">
        <Card className="relative overflow-hidden border-border/70 bg-card/90 shadow-2xs">
          <div className="absolute inset-0 bg-gradient-to-br from-primary/5 via-transparent to-transparent pointer-events-none" />
          <CardContent className="p-4">
            <div className="flex items-center justify-between mb-3">
              <span className="text-[11px] font-semibold text-muted-foreground uppercase tracking-wide">Total OLT Nodes</span>
              <div className="flex h-8 w-8 items-center justify-center rounded-lg bg-primary/10 text-primary border border-primary/20">
                <Network className="h-4 w-4" />
              </div>
            </div>
            <div className="text-2xl font-black tracking-tight text-foreground">{totalOlts}</div>
            <p className="text-muted-foreground mt-1 text-[11px]">Provisioned in GPON network</p>
          </CardContent>
        </Card>
        ...
        <Card className="relative overflow-hidden border-border/70 bg-card/90 shadow-2xs">
          ...
          <CardContent className="p-4">
            <div className="flex items-center justify-between mb-3">
              <span className="text-[11px] font-semibold text-muted-foreground uppercase tracking-wide">Total Optical ONUs</span>
            ...
            <div className="text-2xl font-black tracking-tight text-foreground">{totalOnus}</div>
            <p className="text-muted-foreground mt-1 text-[11px]">Subscribers connected to PON</p>
          </CardContent>
        </Card>
        ...
        <Card className="relative overflow-hidden border-border/70 bg-card/90 shadow-2xs">
          ...
          <CardContent className="p-4">
            ...
            <div className="flex items-center gap-2 mt-1.5">
              <div className="flex-1 h-1.5 rounded-full bg-muted/60 overflow-hidden">
                <div className="h-full rounded-full bg-emerald-500 transition-all duration-500" style={{ width: `${healthPct}%` }} />
              </div>
