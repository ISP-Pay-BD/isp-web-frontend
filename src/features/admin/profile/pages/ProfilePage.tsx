    ...
    >
      ...
      <motion.div variants={itemVariants}>
        <Tabs value={activeTab} onValueChange={setActiveTab} className="space-y-6">
          <TabsList className="bg-card border border-border/80 p-1.5 rounded-xl h-auto gap-1 shadow-sm">
            <TabsTrigger value="overview" className="text-xs font-semibold gap-1.5 py-2.5 px-4 data-[state=active]:bg-primary data-[state=active]:text-primary-foreground data-[state=active]:shadow-md">
              <User className="h-3.5 w-3.5" /> Profile Overview
            </TabsTrigger>
            <TabsTrigger value="edit" className="text-xs font-semibold gap-1.5 py-2.5 px-4 data-[state=active]:bg-primary data-[state=active]:text-primary-foreground data-[state=active]:shadow-md">
              <Edit3 className="h-3.5 w-3.5" /> Update Details
            </TabsTrigger>
            <TabsTrigger value="password" className="text-xs font-semibold gap-1.5 py-2.5 px-4 data-[state=active]:bg-primary data-[state=active]:text-primary-foreground data-[state=active]:shadow-md">
              <Lock className="h-3.5 w-3.5" /> Change Password
            </TabsTrigger>
            <TabsTrigger value="security" className="text-xs font-semibold gap-1.5 py-2.5 px-4 data-[state=active]:bg-primary data-[state=active]:text-primary-foreground data-[state=active]:shadow-md">
